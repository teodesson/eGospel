...
public interface GospelService extends MonitoredService {
    ...
    void save(Configuration ac);

    void delete(Configuration ac);

    Configuration findConfigurationById(String id);

    Page<Configuration> findAllConfiguration(Pageable pageable);

    Long countAllConfiguration();

    Long countConfiguration(String search);

    Page<Configuration> findConfiguration(String search, Pageable pageable);
